...
- 图论: 最小直径生成树, 最优比率生成树, 独立集, 覆盖集, 斯坦纳树, Prufer 序列, LGV 引理, 弦图

- 最短路: 乘积最短路, 同余最短路, $k$ 短路

- 杂项数学: 牛顿迭代, 泰勒级数, 线性规划, $0/1$ 分数规划

- 多项式: 多项式除法, 多项式求逆, 多项式开根, 多项式求对数, 多项式指数函数
...
| 出处                                                            | 题目                           | 知识点                                                                                 |
| --------------------------------------------------------------- | ------------------------------ | -------------------------------------------------------------------------------------- |
| [P3203 HNOI2010](https://www.luogu.com.cn/problem/P3203)        | 弹飞绵羊                       | LCT, Splay                                                                             |
...
| [NOI2011 P2414](https://www.luogu.com.cn/problem/P4022)  | 阿狸的打字机 | ACAM, 树链剖分                              |

## 后期(如果有的话)

后期 (省选-NOI), 大致从四月到七月.

事实证明, 有后期, 但不是完全有. 而且时间也是从六月到七月.

那么就在这里把省选没有学到的知识点贴一下明志:

### 知识清单 (FYS 不会)

这些都是到现在 FYS 还是不会的, 虽然 FYS 已经变成时代的眼泪了, 但是你如果会这些东西你也不一定不会成为时代的眼泪.
...
这些都是省选之后 FYS 学会的, 可以看出如果你去学这些东西, 那么说明你像一个过气 D 类选手一样闲.

#### tyy 中立

- 杂项数学: 牛顿迭代, 泰勒级数

- 多项式: 多项式求逆, 多项式对数函数, 多项式指数函数
