...
export declare type IComponentConstructor<T> = new (props: T, context: any) => IComponent<T, any>;
export interface IComponent<P, S> {
    ...
    displayName?: string;
    refs?: any;
    forceUpdate(callback?: Function): any;
...
export declare type DragEvent<T> = InfernoMouseEvent<T> & NativeDragEvent;
...
export declare type InfernoKeyboardEvent<T> = SemiSyntheticEvent<T> & KeyboardEvent;
export declare type InfernoMouseEvent<T> = SemiSyntheticEvent<T> & MouseEvent;
export declare type InfernoTouchEvent<T> = SemiSyntheticEvent<T> & TouchEvent;
export declare type InfernoPointerEvent<T> = SemiSyntheticEvent<T> & PointerEvent;
export declare type InfernoUIEvent<T> = SemiSyntheticEvent<T> & UIEvent;
export declare type InfernoWheelEvent<T> = InfernoMouseEvent<T> & WheelEvent;
export declare type InfernoAnimationEvent<T> = SemiSyntheticEvent<T> & AnimationEvent;
export declare type InfernoTransitionEvent<T> = SemiSyntheticEvent<T> & TransitionEvent;
export declare type EventHandler<E extends SemiSyntheticEvent<any>> = {
    bivarianceHack(event: E): void;
}['bivarianceHack'] | LinkedEvent<any, E> | null;
export declare type InfernoEventHandler<T = Element> = EventHandler<SemiSyntheticEvent<T>>;
export declare type ClipboardEventHandler<T = Element> = EventHandler<ClipboardEvent<T>>;
export declare type CompositionEventHandler<T = Element> = EventHandler<CompositionEvent<T>>;
export declare type DragEventHandler<T = Element> = EventHandler<DragEvent<T>>;
export declare type FocusEventHandler<T = Element> = EventHandler<FocusEvent<T>>;
...
export declare type KeyboardEventHandler<T = Element> = EventHandler<InfernoKeyboardEvent<T>>;
export declare type MouseEventHandler<T = Element> = EventHandler<InfernoMouseEvent<T>>;
export declare type TouchEventHandler<T = Element> = EventHandler<InfernoTouchEvent<T>>;
export declare type PointerEventHandler<T = Element> = EventHandler<InfernoPointerEvent<T>>;
export declare type UIEventHandler<T = Element> = EventHandler<InfernoUIEvent<T>>;
export declare type WheelEventHandler<T = Element> = EventHandler<InfernoWheelEvent<T>>;
export declare type AnimationEventHandler<T = Element> = EventHandler<InfernoAnimationEvent<T>>;
export declare type TransitionEventHandler<T = Element> = EventHandler<InfernoTransitionEvent<T>>;
export declare type Key = string | number | undefined | null;
export declare type InfernoText = string | number;
export declare type InfernoChild = InfernoElement<any> | InfernoText;
export interface InfernoNodeArray extends Array<InfernoNode> {
}
export declare type InfernoFragment = {} | InfernoNodeArray;
export declare type InfernoNode = InfernoChild | InfernoFragment | JSX.Element | string | number | boolean | null;
...
declare global {
    ...
    interface CSSProperties {
         ...
         */
        'font-size'?: CSSWideKeyword | 'xx-small' | 'x-small' | 'small' | 'medium' | 'large' | 'x-large' | 'xx-large' | 'larger' | 'smaller' | CSSLength | CSSPercentage;
        /**
         ...
         */
        'font-stretch'?: CSSWideKeyword | 'normal' | 'ultra-condensed' | 'extra-condensed' | 'condensed' | 'semi-condensed' | 'semi-expanded' | 'expanded' | 'extra-expanded' | 'ultra-expanded';
        /**
    ...
    namespace JSX {
        ...
        interface ElementClass extends IComponent<any, any> {
            render(nextProps: any, nextState: any, nextContext: any): InfernoNode | undefined | void;
        }
